...
function Animation(){
    return(
        ...
        <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li className="nav-item">
                <a className="nav-link collapsed" href="za" data-toggle="collapse" data-target="#collapseTwo"
            ...
            <li className="nav-item active">
                <a className="nav-link" href="za" data-toggle="collapse" data-target="#collapseUtilities"
            ...
            {/* Nav Item - Pages Collapse Menu */}
            <li className="nav-item">
                <a className="nav-link collapsed" href="za" data-toggle="collapse" data-target="#collapsePages"
                ...
                <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul className="navbar-nav ml-auto">
                        ...
                        <li className="nav-item dropdown no-arrow d-sm-none">
                            <a className="nav-link dropdown-toggle" href="za" id="searchDropdown" role="button"
                        ...
                        <li className="nav-item dropdown no-arrow mx-1">
                            <a className="nav-link dropdown-toggle" href="za" id="alertsDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a className="dropdown-item d-flex align-items-center" href="za">
                                    <div className="mr-3">
                                ...
                                <a className="dropdown-item text-center small text-gray-500" href="za">Show All Alerts</a>
                            </div>
                        </li>

                        {/* Nav Item - Messages */}
                        <li className="nav-item dropdown no-arrow mx-1">
                            <a className="nav-link dropdown-toggle" href="za" id="messagesDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a className="dropdown-item text-center small text-gray-500" href="za">Read More Messages</a>
                            </div>
                        </li>
                        ...
                        <li className="nav-item dropdown no-arrow">
                            <a className="nav-link dropdown-toggle" href="za" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span className="mr-2 d-none d-lg-inline text-gray-600 small">Douglas McGee</span>
                                <img className="img-profile rounded-circle"
                                    src="img/undraw_profile.svg" alt="animation"/>
                            </a>
                            {/* Dropdown - User Information */}
                            <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a className="dropdown-item" href="za">
                                ...
                                <a className="dropdown-item" href="za" data-toggle="modal" data-target="#logoutModal">
                            ...
                            <div className="card position-relative">
                                ...
                                <div className="card-body">
                                    ...
                                    <nav className="navbar navbar-expand navbar-light bg-light mb-4">
                                        <a className="navbar-brand" href="za">Navbar</a>
                                        <ul className="navbar-nav ml-auto">
                                            <li className="nav-item dropdown">
                                                <a className="nav-link dropdown-toggle" href="za" id="navbarDropdown"
                                                ...
                                                <div className="dropdown-menu dropdown-menu-right animated--grow-in"
                                                    ...
                                                    <a className="dropdown-item" href="za">Action</a>
                                                    <a className="dropdown-item" href="za">Another action</a>
                                                    <div className="dropdown-divider"></div>
                                                    <a className="dropdown-item" href="za">Something else here</a>
                                                </div>
                                            </li>
                                        </ul>
                                    </nav>
