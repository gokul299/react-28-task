      ...
      <div id="wrapper">
          ...
          <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
              ...
              <li className="nav-item">
                  <a className="nav-link collapsed" href ="c" data-toggle="collapse" data-target="#collapseTwo"
              ...
              <li className="nav-item">
                  <a className="nav-link collapsed" href ="c" data-toggle="collapse" data-target="#collapseUtilities"
              ...
              {/* <!-- Nav Item - Pages Collapse Menu --> */}
              <li className="nav-item">
                  <a className="nav-link collapsed" href ="c" data-toggle="collapse" data-target="#collapsePages"
              ...
              <div className="sidebar-card d-none d-lg-flex">
                  <img className="sidebar-card-illustration mb-2" src="img/undraw_rocket.svg" alt="parent"/>
                          ...
                          <li className="nav-item dropdown no-arrow">
                              <a className="nav-link dropdown-toggle" href ="c" id="userDropdown" role="button"
                                  ...
                                  <img className="img-profile rounded-circle"
                                      src="img/undraw_profile.svg" alt="parent"/>
                              </a>
                              ...
                              <div className="card shadow mb-4">
                                  ...
                                  <div
                                      ...
                                      <div className="dropdown no-arrow">
                                          <a className="dropdown-toggle" href="a" role="button" id="dropdownMenuLink"
                                              data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          ...
                          <div className="col-xl-4 col-lg-5">
                              <div className="card shadow mb-4">
                                  ...
                                  <div
                                      ...
                                      <div className="dropdown no-arrow">
                                          <a className="dropdown-toggle" href ="c" role="button" id="dropdownMenuLink"
                                              data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                              <i className="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                          </a>
                                          <div className="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                  ...
                                  <div className="card-body">
                                      ...
                                      {/* <canvas id="myPieChart" width="310" height="306" style={{display: "block", height: "245px", width: "248px"}} className="chartjs-render-monitor"></canvas> */}
                                      </div>
                                  ...
                                  <div className="card-body">
                                      <div className="text-center">
                                          <img className="img-fluid px-3 px-sm-4 mt-3 mb-4" style={{width: "25rem"}}
                                              src="img/undraw_posting_photo.svg" alt="parent"/>
                                      </div>
