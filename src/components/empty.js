...
function Empty(){
    return(
        ...
        <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li className="nav-item">
                <a className="nav-link collapsed" href="bb" data-toggle="collapse" data-target="#collapseTwo"
            ...
            <li className="nav-item">
                <a className="nav-link collapsed" href="bb" data-toggle="collapse" data-target="#collapseUtilities"
            ...
            <li className="nav-item active">
                <a className="nav-link" href="bb" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true"
                ...
                <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul className="navbar-nav ml-auto">
                        ...
                        <li className="nav-item dropdown no-arrow d-sm-none">
                            <a className="nav-link dropdown-toggle" href="bb" id="searchDropdown" role="button"
                        ...
                        <li className="nav-item dropdown no-arrow mx-1">
                            <a className="nav-link dropdown-toggle" href="bb" id="alertsDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a className="dropdown-item d-flex align-items-center" href="bb">
                                    <div className="mr-3">
                                ...
                                <a className="dropdown-item text-center small text-gray-500" href="bb">Show All Alerts</a>
                            </div>
                        </li>

                        {/* Nav Item - Messages */}
                        <li className="nav-item dropdown no-arrow mx-1">
                            <a className="nav-link dropdown-toggle" href="bb" id="messagesDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a className="dropdown-item text-center small text-gray-500" href="bb">Read More Messages</a>
                            </div>
                        </li>
                        ...
                        <li className="nav-item dropdown no-arrow">
                            <a className="nav-link dropdown-toggle" href="bb" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span className="mr-2 d-none d-lg-inline text-gray-600 small">Douglas McGee</span>
                                <img className="img-profile rounded-circle"
                                    src="img/undraw_profile.svg" alt="page"/>
                            </a>
                            ...
                            <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a className="dropdown-item" href="bb" data-toggle="modal" data-target="#logoutModal">
